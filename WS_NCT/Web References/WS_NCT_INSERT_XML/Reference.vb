...
'
Namespace WS_NCT_INSERT_XML
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2556.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Web.Services.WebServiceBindingAttribute(Name:="NCT_INSERT_XMLSoap", [Namespace]:="http://tempuri.org/")>  _
    Partial Public Class NCT_INSERT_XML
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.WS_NCT.My.MySettings.Default.WS_NCT_WS_NCT_INSERT_XML_NCT_INSERT_XML
        ...
        Public Function NCT_INSERT(ByRef IDA As String, ByRef filename As String) As String
            Dim results() As Object = Me.Invoke("NCT_INSERT", New Object() {IDA, filename})
            IDA = CType(results(1),String)
            filename = CType(results(2),String)
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub NCT_INSERTAsync(ByVal IDA As String, ByVal filename As String)
            Me.NCT_INSERTAsync(IDA, filename, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub NCT_INSERTAsync(ByVal IDA As String, ByVal filename As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("NCT_INSERT", New Object() {IDA, filename}, Me.NCT_INSERTOperationCompleted, userState)
        End Sub
    ...
    Partial Public Class NCT_INSERTCompletedEventArgs
        ...
        '''<remarks/>
        Public ReadOnly Property IDA() As String
            Get
                Me.RaiseExceptionIfNecessary
